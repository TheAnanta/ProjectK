<template>
    ...
    <v-app>
        <NuxtLayout>
            <div style="background-color: #141218; width: 100%; height: 100%;">
                <NavigationRail />
                <div style="width: 100vw; height: 360px; padding: 10px 40px 30px 130px;">
                    <v-col>
                        <v-row justify="end" style="margin: 0;">
                            <v-icon
                                style="color: var(--secondary-txt-color); width: 20px; height: 20px; cursor: pointer;">mdi-account-circle-outline</v-icon>
                        </v-row>

                        <div
                            style="display: flex; flex-direction: column; justify-content: start; align-items: start; gap: 12px; color: white; margin-top: 60px;">
                            <!-- Headline -->
                            ...
                            <p style="font-size: 12px; font-weight:400; margin-bottom: 20px;">
                                Lorem ipsum dolor sit amet, consectetur adipiscing elit. <br> Ut ut enim et neque
                                aliquam
                                ultricies vel eu ipsum.
                            </p>
                        </div>
                        <!-- Event Cards -->
                        <div style="margin-top: 20px; display: grid; grid-template-columns: repeat(3, minmax(0, 1fr)); gap: 30px;">
                            <div v-for="(item, index) in eventDetails" :key="index">
                                <DashboardEventCard :data="item"/>
                            </div>
                        </div>
